                                ...
                                <tr>
                                    ...
                                    <td style="padding-bottom:12px">
                                        <span style="display:inline-block; margin-bottom:3px"><select name="day" id="day" style="width:48px">
                                            ...
                                            </select>&nbsp; </span>&nbsp; <span id="dateLoaded" style="position:relative; top:2px; padding:2px 6px; display:none" class="nw label-green">Установлена дата из EXIF</span><span id="dateAbsent" style="position:relative; top:2px; padding:2px 6px; display:none" class="nw label-orange">Укажите дату съёмки (нет в EXIF)</span>&nbsp; <span class="sm nw"><a href="#" class="dot" onclick="setDate(05,07,2024); return false">Сегодня</a> &middot; <a href="#" class="dot" onclick="setDate(04,07,2024); return false">Вчера</a> &middot; <a href="#" class="dot" onclick="setDate(0,0,0); return false">Неизвестно</a></span>
                                    </td>
                                </tr>
                            </tbody>
